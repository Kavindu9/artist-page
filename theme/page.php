    ...
    <header class="container px-4 sm:px-10 max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-10 sm:gap-y-2 mb-24">
        ...
        <div class="col-span-1 lg:col-span-2 lg:col-start-2">
            ...
            <div class="page-action line-button group ">
                <a <?php if($is_modal){ echo "data-fancybox data-type='iframe'"; } ?> href="<?php echo $button_url; ?>" class="inline-block text-base font-bold py-3 text-sapphire-blue-900 hover:text-sapphire-blue-500 transition ease-out duration-150"><?php echo $button_text; ?></a>
