...
<article class="py-20 lg:py-36">
    <header class="container px-4 sm:px-10 max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-10 sm:gap-y-2 mb-24">
        ...
        <aside class="col-span-1 lg:col-span-1 lg:order-1">
            <lottie-player src="https://assets10.lottiefiles.com/packages/lf20_hhr9johk.json" background="transparent" speed="1" style="width: 130px; margin:auto;" loop autoplay></lottie-player>
        </aside>
    </header>
